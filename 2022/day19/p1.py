...
def get_quality_lvl(blueprint, time=24):
...
if __name__ == "__main__":
	...
	with concurrent.futures.ProcessPoolExecutor() as executor:
		for quality_lvl in executor.map(get_quality_lvl, blueprints):
			quality_levels.append(quality_lvl)
	print("Duration: ", (time.time() - start)/60, " minutes") # 1.4531378269195556 minutes
	print("Part 1: ", sum(quality_levels)) # 1389
