...
def shortest_path(horizontal_states, vertical_states, x_rng, y_rng, delta_x, delta_y, start, goal, t0):
	...
	while heap:
		...
		for x, y in [(0, 1), (0, -1), (1, 0), (-1, 0), (0, 0)]:
			...
			if ((x_rng[0] <= new_pos[0] <= x_rng[1]) and (y_rng[0] <= new_pos[1] <= y_rng[1]) or new_pos == goal):
...
if __name__ == "__main__":
	...
	print("Part 1: ", shortest_path(horizontal_states, vertical_states, x_rng, y_rng, delta_x, delta_y, start, goal, 0)) # 274
